...
public class Utils {
    ...
    public static String vnp_TmnCode = "HTGLOB01";
    public static String vnp_HashSecret = "WGRJJZIUDNTZCUSGELGEDUFOJWDOUOXK";
    ...
    //Util for VNPAY
    public static String hashAllFields(String hashSecret, Map fields) throws UnsupportedEncodingException {
